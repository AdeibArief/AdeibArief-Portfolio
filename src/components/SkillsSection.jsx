...
const skills = [
  ...
  { name: "Data Science Fundamentals", level: 70, category: "ai" },
  { name: "Pandas & NumPy", level: 75, category: "ai" },
  { name: "NLP (Basic)", level: 65, category: "ai" },

  // Tools
  { name: "Git & GitHub", level: 85, category: "tools" },
  { name: "VS Code", level: 90, category: "tools" },
  { name: "Postman", level: 80, category: "tools" },
  { name: "Render / Vercel Deployment", level: 70, category: "tools" },
];
